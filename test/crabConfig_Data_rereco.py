...
#config.General.requestName = 'DoubleEG_Run2016B-23Sep2016-v3_AOD_resubmit2'
...
#config.General.requestName = 'DoubleEG_Run2016F-23Sep2016-v1_AOD_resubmit'
#config.General.requestName = 'DoubleEG_Run2016G-23Sep2016-v1_AOD_resubmit'
config.General.requestName = 'DoubleEG_Run2016H-PromptReco-v3_AOD_resubmit'
...
#config.Data.lumiMask = 'B_JSON.txt'
#config.Data.lumiMask = 'C_JSON.txt'
#config.Data.lumiMask = 'D_JSON.txt'
#config.Data.lumiMask = 'F_JSON.txt'
#config.Data.lumiMask = 'G_JSON.txt'
config.Data.lumiMask = 'H_JSON.txt'
